  ...
  if (this.hasValue("v-wf:isProcess")) {
    ...
    for (var i = 1; i <= 6; i++) {
      if (individual.hasValue(complex+"coordination"+i)){
        individual[complex+'coordination'+i][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionAgreed'),
    ...
    if (individual.hasValue(complex+"sign")) {
      individual[complex+'sign'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionSign'), new IndividualModel('v-wf:DecisionDeclined'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"approval")) {
      individual[complex+'approval'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionApprove'), new IndividualModel('v-wf:DecisionDeclined'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"review")) {
      individual[complex+'review'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionReview'), new IndividualModel('v-wf:DecisionRejected'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"instruction")) {
      individual[complex+'instruction'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionAchieved'), new IndividualModel('v-wf:DecisionRejected'), new IndividualModel('v-wf:DecisionNotPerformed'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"instruction2")) {
      individual[complex+'instruction2'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionAchieved'), new IndividualModel('v-wf:DecisionRejected'), new IndividualModel('v-wf:DecisionNotPerformed'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"instruction3")) {
      individual[complex+'instruction3'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionAchieved'), new IndividualModel('v-wf:DecisionRejected'), new IndividualModel('v-wf:DecisionNotPerformed'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"instruction4")) {
      individual[complex+'instruction4'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionAchieved'),new IndividualModel('v-wf:DecisionRejected'), new IndividualModel('v-wf:DecisionNotPerformed'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"examination")) {
      individual[complex+'examination'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionExamined'), new IndividualModel('v-wf:DecisionNotForMe')];
    ...
    if (individual.hasValue(complex+"examination2")) {
      individual[complex+'examination2'][0][simple+'possible_decisions'] = [new IndividualModel('v-wf:DecisionExamined'), new IndividualModel('v-wf:DecisionNotForMe')];
